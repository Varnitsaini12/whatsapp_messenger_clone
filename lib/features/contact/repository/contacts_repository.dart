...
class ContactsRepository {
  ...
  Future<List<List>> getAllContacts() async {
    //These are the contacts that are saved in the user's phone and have an account
    List<UserModel> firebaseContacts = [];
    //These are the contacts that are saved in the user's phone and doesn't have an account
